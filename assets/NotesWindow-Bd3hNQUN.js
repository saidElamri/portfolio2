import{j as e}from"./three-C6a0JU4S.js";import{b as o,m as p}from"./vendor-CbuxiZIF.js";import{a as u,t as w}from"./index-BPagPQF1.js";import{j as f,aa as b,w as g,ab as v}from"./ui-Dvyu2D3C.js";const c=[{id:1,title:"The Future of AI in Web Development",date:"2024-03-15",tags:["AI","Web","Future"],content:`
...
It's been a fun journey of fighting z-indexes and event propagation!
        `}],S=()=>{const{currentTheme:d}=u(),r=w[d],[a,h]=o.useState(c[0]),[i,m]=o.useState(""),[l,n]=o.useState(!0),x=c.filter(t=>t.title.toLowerCase().includes(i.toLowerCase())||t.tags.some(s=>s.toLowerCase().includes(i.toLowerCase())));return e.jsxs("div",{className:"flex h-full text-white bg-transparent",children:[e.jsxs("div",{className:`${l?"w-full md:w-64":"hidden md:block w-64"} flex flex-col border-r shrink-0 transition-all`,style:{borderColor:r.border,backgroundColor:"rgba(0,0,0,0.2)"},children:[e.jsx("div",{className:"p-4 border-b",style:{borderColor:r.border},children:e.jsxs("div",{className:"relative",children:[e.jsx(f,{className:"absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-white/40"}),e.jsx("input",{type:"text",placeholder:"Search notes...",value:i,onChange:t=>m(t.target.value),className:"w-full bg-white/5 rounded-lg pl-9 pr-3 py-2 text-sm outline-none focus:bg-white/10 transition-colors"})]})}),e.jsx("div",{className:"flex-1 overflow-y-auto p-2 space-y-1 custom-scrollbar",children:x.map(t=>e.jsxs("button",{onClick:()=>{h(t),window.innerWidth<768&&n(!1)},className:`w-full text-left p-3 rounded-lg transition-all group ${a.id===t.id?"bg-white/10":"hover:bg-white/5"}`,children:[e.jsx("h3",{className:`text-sm font-semibold mb-1 ${a.id===t.id?"text-white":"text-white/80"}`,children:t.title}),e.jsxs("div",{className:"flex items-center gap-2 text-[10px] text-white/40",children:[e.jsx("span",{children:t.date}),t.tags.length>0&&e.jsx("span",{className:"px-1.5 py-0.5 rounded-md bg-white/5 text-white/50",children:t.tags[0]})]})]},t.id))})]}),e.jsxs("div",{className:`${l?"hidden md:flex flex-1":"flex-1"} flex-col bg-opacity-50`,children:[e.jsx("div",{className:"md:hidden p-4 border-b flex items-center gap-2",style:{borderColor:r.border},children:e.jsxs("button",{onClick:()=>n(!0),className:"flex items-center gap-1 text-sm text-white/60 hover:text-white",children:[e.jsx(b,{className:"w-4 h-4"})," Back"]})}),e.jsx("div",{className:"flex-1 overflow-y-auto p-8 custom-scrollbar",children:e.jsxs(p.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{duration:.3},className:"max-w-2xl mx-auto prose prose-invert prose-sm md:prose-base",children:[e.jsxs("div",{className:"mb-8 border-b pb-6",style:{borderColor:r.border},children:[e.jsxs("div",{className:"flex items-center gap-3 text-sm text-white/40 mb-4",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(g,{className:"w-4 h-4"}),a.date]}),e.jsx("div",{className:"flex items-center gap-2",children:a.tags.map(t=>e.jsxs("div",{className:"flex items-center gap-1 px-2 py-0.5 rounded-full bg-white/5",children:[e.jsx(v,{className:"w-3 h-3"}),t]},t))})]}),e.jsx("h1",{className:"text-3xl font-bold text-white mb-2",children:a.title})]}),e.jsx("div",{className:"whitespace-pre-wrap leading-relaxed text-white/80 space-y-4",children:a.content.split(`
